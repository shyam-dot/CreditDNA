...
import { Terminal, Cpu, ChevronRight, LogIn, Gauge, Zap, UserCheck, Code2 } from 'lucide-react';
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Operational Badge */}
          <div className="hidden sm:flex items-center gap-2 px-2.5 py-1 rounded-md bg-emerald-950/60 border border-emerald-500/30 text-[11px] font-mono text-emerald-400">
        ...
        {/* Navigation Links (Prettier glass pill buttons) */}
        <nav className="hidden lg:flex items-center gap-2 text-xs font-mono">
          <a
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/login"
            className="hidden sm:inline-flex items-center gap-1.5 text-xs font-mono text-gray-300 hover:text-white px-3 py-2 rounded-lg hover:bg-white/5 transition-colors"
          >
          ...
          <Link
            to="/dashboard"
            className="btn-primary py-2 px-4 text-xs font-mono tracking-wide flex items-center gap-1.5"
          >
            <Terminal className="w-3.5 h-3.5 text-[#0B0F19]" />
            <span>TERMINAL</span>
